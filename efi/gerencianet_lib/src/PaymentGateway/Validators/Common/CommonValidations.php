...
class CommonValidations
{
     ...
     * @return boolean
     */
    static function _corporate($data)
    {
        $validation = preg_match("/^[ ]*(?:[^\\s]+[ ]+)*[^\\s]+[ ]*$/", $data);
        if (!$validation || strlen($data) < 2) {
            return false;
     ...
     * @return boolean
     */
    static function _birthdate($data)
    {
        $birth = explode("-", $data);
     ...
     * @return boolean
     */
    static function _phone_number($data)
    {
     ...
     * @return boolean
     */
    static function _neighborhood($data)
    {
     ...
     * @return boolean
     */
    static function _cardNumber($data)
    {
        $validation = false;
        $brands = array(
